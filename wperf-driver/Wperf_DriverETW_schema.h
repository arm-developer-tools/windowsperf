...
//+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
// Provider "Wperf_Driver" event count 1
//+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++

// Provider GUID = 9b15b4b5-6979-4ba7-9b26-00c630a4d7b3
EXTERN_C __declspec(selectany) const GUID DriverControlGuid = {0x9b15b4b5, 0x6979, 0x4ba7, {0x9b, 0x26, 0x00, 0xc6, 0x30, 0xa4, 0xd7, 0xb3}};
...
// Channel
//
#define DriverControlGuid_CHANNEL_WPERFDRIVER 0x10
#define DriverControlGuid_CHANNEL_WPERFDRIVER_KEYWORD 0x8000000000000000

//
// Event Descriptors
//
EXTERN_C __declspec(selectany) const EVENT_DESCRIPTOR CustomEventTraceInfo = {0x5, 0x0, 0x10, 0x0, 0x0, 0x0, 0x8000000000000000};
#define CustomEventTraceInfo_value 0x5
...
//
EXTERN_C __declspec(selectany) DECLSPEC_CACHEALIGN ULONG Wperf_DriverEnableBits[1];
EXTERN_C __declspec(selectany) const ULONGLONG Wperf_DriverKeywords[1] = {0x8000000000000000};
EXTERN_C __declspec(selectany) const unsigned char Wperf_DriverLevels[1] = {0};

//
// Provider context
//
EXTERN_C __declspec(selectany) MCGEN_TRACE_CONTEXT DriverControlGuid_Context = {0, (ULONG_PTR)DriverControlGuid_Traits, 0, 0, 0, 0, 0, 0, 1, Wperf_DriverEnableBits, Wperf_DriverKeywords, Wperf_DriverLevels};

//
// Provider REGHANDLE
//
#define Wperf_DriverHandle (DriverControlGuid_Context.RegistrationHandle)
...
//
#ifndef EventRegisterWperf_Driver
#define EventRegisterWperf_Driver() McGenEventRegister(&DriverControlGuid, McGenControlCallbackV2, &DriverControlGuid_Context, &Wperf_DriverHandle)
#endif
...
//
#ifndef EventRegisterByGuidWperf_Driver
#define EventRegisterByGuidWperf_Driver(Guid) McGenEventRegister(&(Guid), McGenControlCallbackV2, &DriverControlGuid_Context, &Wperf_DriverHandle)
#endif
...
//
#ifndef EventUnregisterWperf_Driver
#define EventUnregisterWperf_Driver() McGenEventUnregister(&Wperf_DriverHandle)
#endif
...
// - Caller allocates memory, e.g. pContext = malloc(sizeof(McGenContext_Wperf_Driver));
// - Caller registers the provider, e.g. EventRegisterWperf_Driver_ForContext(pContext);
// - Caller writes events, e.g. EventWriteMyEvent_ForContext(pContext, ...);
// - Caller unregisters, e.g. EventUnregisterWperf_Driver_ForContext(pContext);
// - Caller frees memory, e.g. free(pContext);
//

typedef struct tagMcGenContext_Wperf_Driver {
    // The fields of this structure are subject to change and should
    // not be accessed directly. To access the provider's REGHANDLE,
    // use Wperf_DriverHandle_ForContext(pContext).
    MCGEN_TRACE_CONTEXT Context;
    ULONG EnableBits[1];
} McGenContext_Wperf_Driver;

#define EventRegisterWperf_Driver_ForContext(pContext)             _mcgen_PASTE2(_mcgen_RegisterForContext_Wperf_Driver_, MCGEN_EVENTREGISTER)(&DriverControlGuid, pContext)
#define EventRegisterByGuidWperf_Driver_ForContext(Guid, pContext) _mcgen_PASTE2(_mcgen_RegisterForContext_Wperf_Driver_, MCGEN_EVENTREGISTER)(&(Guid), pContext)
#define EventUnregisterWperf_Driver_ForContext(pContext)           McGenEventUnregister(&(pContext)->Context.RegistrationHandle)

//
// Provider REGHANDLE for caller-allocated context.
//
#define Wperf_DriverHandle_ForContext(pContext) ((pContext)->Context.RegistrationHandle)

// This function is for use by MC-generated code and should not be used directly.
// Initialize and register the caller-allocated context.
__inline
ULONG __stdcall
_mcgen_PASTE2(_mcgen_RegisterForContext_Wperf_Driver_, MCGEN_EVENTREGISTER)(
    _In_ LPCGUID pProviderId,
    _Out_ McGenContext_Wperf_Driver* pContext)
{
    RtlZeroMemory(pContext, sizeof(*pContext));
    pContext->Context.Logger = (ULONG_PTR)DriverControlGuid_Traits;
    pContext->Context.EnableBitsCount = 1;
    pContext->Context.EnableBitMask = pContext->EnableBits;
    pContext->Context.EnableKeyWords = Wperf_DriverKeywords;
    pContext->Context.EnableLevel = Wperf_DriverLevels;
...
FORCEINLINE
_Ret_ McGenContext_Wperf_Driver*
_mcgen_CheckContextType_Wperf_Driver(_In_ McGenContext_Wperf_Driver* pContext)
{
    return pContext;
}
...
//
// Enablement check macro for event "CustomEventTraceInfo"
//
#define EventEnabledCustomEventTraceInfo() _mcgen_EVENT_BIT_SET(Wperf_DriverEnableBits, 0)
#define EventEnabledCustomEventTraceInfo_ForContext(pContext) _mcgen_EVENT_BIT_SET(_mcgen_CheckContextType_Wperf_Driver(pContext)->EnableBits, 0)

//
// Event write macros for event "CustomEventTraceInfo"
//
#define EventWriteCustomEventTraceInfo(Activity, Text, Status) \
        MCGEN_EVENT_ENABLED(CustomEventTraceInfo) \
        ? _mcgen_TEMPLATE_FOR_CustomEventTraceInfo(&DriverControlGuid_Context, &CustomEventTraceInfo, Activity, Text, Status) : 0
#define EventWriteCustomEventTraceInfo_AssumeEnabled(Text, Status) \
        _mcgen_TEMPLATE_FOR_CustomEventTraceInfo(&DriverControlGuid_Context, &CustomEventTraceInfo, NULL, Text, Status)
#define EventWriteCustomEventTraceInfo_ForContext(pContext, Activity, Text, Status) \
        MCGEN_EVENT_ENABLED_FORCONTEXT(pContext, CustomEventTraceInfo) \
        ? _mcgen_TEMPLATE_FOR_CustomEventTraceInfo(&(pContext)->Context, &CustomEventTraceInfo, Activity, Text, Status) : 0
#define EventWriteCustomEventTraceInfo_ForContextAssumeEnabled(pContext, Text, Status) \
        _mcgen_TEMPLATE_FOR_CustomEventTraceInfo(&_mcgen_CheckContextType_Wperf_Driver(pContext)->Context, &CustomEventTraceInfo, NULL, Text, Status)

// This macro is for use by MC-generated code and should not be used directly.
#define _mcgen_TEMPLATE_FOR_CustomEventTraceInfo _mcgen_PASTE2(McTemplateK0sq_, MCGEN_EVENTWRITETRANSFER)
...
//
// Function for template "tid_trace_template" (and possibly others).
// This function is for use by MC-generated code and should not be used directly.
//
#ifndef McTemplateK0sq_def
#define McTemplateK0sq_def
ETW_INLINE
ULONG
_mcgen_PASTE2(McTemplateK0sq_, MCGEN_EVENTWRITETRANSFER)(
    _In_ PMCGEN_TRACE_CONTEXT Context,
    _In_ PCEVENT_DESCRIPTOR Descriptor,
...
{
#define McTemplateK0sq_ARGCOUNT 2

    EVENT_DATA_DESCRIPTOR EventData[McTemplateK0sq_ARGCOUNT + 1];
    ...
    return McGenEventWrite(Context, Descriptor, Activity, McTemplateK0sq_ARGCOUNT + 1, EventData);
}
#endif // McTemplateK0sq_def
...
#define MSG_EventTraceInfo_EventMessage      0xB0000005L
